# Archived: Original v1.5.0 UX Wishlist (Deferred, Unscheduled)

**Archived**: 2026-07-08
**Reason**: The JOSS pre-review of VideoAnnotator (#10182) and Video Annotation Viewer (#10183) raised
concerns about install footprint, monolithic packaging, and evidence of active cross-project integration.
Responding to that feedback took priority over this wishlist, so the v1.5.0 and v1.6.0 slots were
reassigned to the modular-pipeline-architecture work and the FastAPI/VAV integration
(see [`roadmap_v1.5.0.md`](../../development/roadmap_v1.5.0.md)) and to plugin ecosystem + local LLM
backend support (see [`roadmap_v1.6.0.md`](../../development/roadmap_v1.6.0.md)).

The content below is the original v1.5.0 plan, preserved as-is. None of it has been done; it has no
committed release slot. Revisit and re-prioritize into a future roadmap (v1.7.0+) once the modularity
and integration work lands.
