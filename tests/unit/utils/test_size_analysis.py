...
class TestPersonTrackingSizeAnalysisIntegration:
    ...
    def test_person_tracking_with_size_analysis(self, mock_yolo_class, mock_video_capture_class, 
                                               pipeline_config, mock_video_capture, mock_yolo_results):
        ...
        size_based_annotations = [ann for ann in annotations 
    ...
    def test_minimum_detections_filtering(self, pipeline_config):
        ...
        pipeline_config["person_identity"]["automatic_labeling"]["size_based"]["min_detections_for_analysis"] = 3
        ...
        # Filter annotations
        filtered_tracks = [ann for ann in annotations 
    ...
    def test_size_analysis_function_called(self, mock_size_analysis, pipeline_config):
        ...
        if size_based_config.get("use_simple_analyzer", True) and size_based_config.get("enabled", True):
    ...
    def test_configuration_backward_compatibility(self):
        ...
        size_config = pipeline2.config["person_identity"]["automatic_labeling"]["size_based"]
...
class TestSizeBasedAnalysisConfiguration:
    ...
    def test_configuration_override(self):
        ...
        size_config = pipeline.config["person_identity"]["automatic_labeling"]["size_based"]
