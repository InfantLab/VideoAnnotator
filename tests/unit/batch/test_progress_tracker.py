...
from src.batch.types import JobStatus, BatchJob, BatchStatus, PipelineResult
...
class TestProgressTracker:
    ...
    def test_get_status_with_jobs(self):
        ...
        assert status.success_rate == pytest.approx(50.0, abs=0.1)  # 2 completed out of 4 finished jobs (2+1+1)
