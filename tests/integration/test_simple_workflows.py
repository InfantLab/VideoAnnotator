...
class TestBatchIntegrationSimple:
    ...
    def test_orchestrator_progress_tracker_integration(self):
        ...
        job_id2 = self.orchestrator.add_job(str(test_video2))
    ...
    def test_full_component_integration(self):
        ...
        assert self.orchestrator.storage_backend.annotation_exists(job_id, "scene_detection")
        loaded_annotations = self.orchestrator.storage_backend.load_annotations(job_id, "scene_detection")
