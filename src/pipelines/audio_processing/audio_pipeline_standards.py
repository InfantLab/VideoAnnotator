    ...
    def _save_results(
        ...
        if results['speech']:
            ...
            if validation_result.is_valid:
                ...
                self.logger.warning(f"WebVTT validation warnings: {', '.join(validation_result.warnings)}")
        ...
        if results['diarization']:
            ...
            if validation_result.is_valid:
                ...
                self.logger.warning(f"RTTM validation warnings: {', '.join(validation_result.warnings)}")
