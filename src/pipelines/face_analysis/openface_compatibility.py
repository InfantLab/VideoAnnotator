...
class FaceDetector:
    ...
    def __init__(self, model_path: Optional[str] = None, confidence_threshold: float = 0.5, device: str = "cpu"):
...
class LandmarkDetector:
    ...
    def __init__(self, model_path: Optional[str] = None, model_type: str = "98_point", 
                 enable_3d: bool = False, device: str = "cpu"):
        self.model_path = model_path
...
class ActionUnitAnalyzer:
    ...
    def analyze(self, face_image: np.ndarray, landmarks: Dict[str, Any]) -> Dict[str, Any]:
...
class HeadPoseEstimator:
    ...
    def estimate(self, face_image: np.ndarray, landmarks: Dict[str, Any]) -> Dict[str, Any]:
        """Estimate head pose."""
        raise OpenFaceNotAvailableError(
            "OpenFace 3.0 is not installed. Please install it from "
            "https://github.com/CMU-MultiComp-Lab/OpenFace-3.0"
...
class EmotionRecognizer:
    ...
    def recognize(self, face_image: np.ndarray, landmarks: Dict[str, Any]) -> Dict[str, Any]:
        """Recognize emotions."""
        raise OpenFaceNotAvailableError(
            "OpenFace 3.0 is not installed. Please install it from "
            "https://github.com/CMU-MultiComp-Lab/OpenFace-3.0"
