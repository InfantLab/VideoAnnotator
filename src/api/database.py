...
def check_database_health() -> tuple[bool, str]:
    ...
    try:
        ...
        return True, f"Database healthy - {stats['total_jobs']} jobs in {stats['backend']} backend"
...
class DatabaseSession:
    ...
    def __enter__(self):
        if hasattr(self.storage, 'SessionLocal'):
            ...
            raise NotImplementedError("Direct session access not supported for this backend")
