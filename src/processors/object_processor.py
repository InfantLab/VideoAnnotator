...
def extract_objects_from_video(video_path, model=None, confidence=0.4, tracker="bytetrack"):
    ...
    results = model.track(source=video_path, stream=True, conf=confidence, save=False, tracker=tracker)
...
def process_video_objects(video_path, output_dir, video_metadata=None, poses_df=None,
                         confidence=0.4, model_path='yolov8n.pt', force_process=False):
    """
