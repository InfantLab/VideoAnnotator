...
if __name__ == "__main__":
    ...
    parser.add_argument("command", choices=["init", "admin", "info", "backup"], 
                       help="Migration command to run")
    parser.add_argument("--force", action="store_true", 
                       help="Force operation (recreate tables)")
    parser.add_argument("--username", default="admin", 
                       help="Admin username")
    parser.add_argument("--email", default="admin@videoannotator.com", 
                       help="Admin email")
