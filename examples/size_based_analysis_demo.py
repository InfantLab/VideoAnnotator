...
def create_sample_data():
    ...
    sample_annotations = [
        ...
        {"person_id": "person_babyvideo_001", "bbox": [150, 100, 100, 200], "frame_number": 1, "timestamp": 0.5},
        {"person_id": "person_babyvideo_001", "bbox": [155, 105, 95, 195], "frame_number": 5, "timestamp": 2.5},
        {"person_id": "person_babyvideo_001", "bbox": [160, 110, 98, 200], "frame_number": 10, "timestamp": 5.0},
        {"person_id": "person_babyvideo_001", "bbox": [145, 95, 102, 205], "frame_number": 15, "timestamp": 7.5},
        
        # Child person (person_002) - consistently smaller bounding boxes  
        {"person_id": "person_babyvideo_002", "bbox": [300, 180, 60, 90], "frame_number": 1, "timestamp": 0.5},
        {"person_id": "person_babyvideo_002", "bbox": [305, 175, 58, 88], "frame_number": 5, "timestamp": 2.5},
        {"person_id": "person_babyvideo_002", "bbox": [298, 185, 62, 92], "frame_number": 10, "timestamp": 5.0},
        {"person_id": "person_babyvideo_002", "bbox": [302, 178, 59, 89], "frame_number": 15, "timestamp": 7.5},
        
        # Another adult (person_003) - similar size to person_001
        {"person_id": "person_babyvideo_003", "bbox": [50, 120, 105, 190], "frame_number": 8, "timestamp": 4.0},
        {"person_id": "person_babyvideo_003", "bbox": [55, 115, 100, 195], "frame_number": 12, "timestamp": 6.0},
        {"person_id": "person_babyvideo_003", "bbox": [48, 125, 108, 188], "frame_number": 16, "timestamp": 8.0},
    ]
...
def demo_analyzer_class():
    ...
    print(f"Analyzer settings: threshold={analyzer.height_threshold}, confidence={analyzer.confidence}")
...
def demo_edge_cases():
    ...
    for person_id, info in results.items():
        print(f"{person_id}: {info['label']} (normalized_height={info['metadata']['normalized_height']:.2f})")
...
def main():
    ...
    print("="*60)
    print("\nKey takeaways:")
    print("1. Size-based inference classifies persons as adult/child based on relative heights")
    ...
    print("4. The analyzer handles edge cases gracefully (single person, invalid data, etc.)")
