...
Both tools were developed at Stellenbosch University to support analysis of caregiver–child interaction videos collected across multiple sites in sub-Saharan Africa as part of the Global Parenting Initiative. They consolidate analysis workflows that the authors developed at Goldsmiths, University of London, and Stellenbosch University. Those workflows have supported published studies of toddler sensorimotor synchronisation [@rocha2022] and mother–infant synchrony [@stamate2023; @stamate2024], and an evaluation of facial emotion recognition models on caregiver–child interaction video [@uwerikowe2026]. VideoAnnotator and VAV are now used for ongoing parenting-intervention research within the authors' group, and were presented at the International Conference on Infant Studies (Glasgow, 2024). The local-first design was motivated by the ethical and governance requirements of working with video recordings of children in low- and middle-income settings. Pilot analyses have been run on over 500 videos, and the software is being prepared for use in upcoming multi-site trials. A practical motivating example: VAV's synchronized multi-track timeline makes turn-taking patterns in caregiver–child interaction visible at a glance, a cue to reciprocity that is important for developmental assessment but difficult to judge from tabular outputs alone.
